      ...
      <div>
        ...
        <p className="mt-2 text-base text-foreground/80 leading-relaxed max-w-3xl">
          {de
            ...
            : "This page runs automated checks against Eurostat employment totals, Statistik Austria VSE earnings, and the new occupation-first logic around ISCO families, pay, AI exposure, and ÖNACE context. Use it to verify that the dataset’s core claims still hold."}
        </p>
      </div>
