...
// Static font weights from Google Fonts CDN (variable fonts don't work with satori)
const hankenGroteskRegular =
  'https://fonts.gstatic.com/s/hankengrotesk/v12/ieVq2YZDLWuGJpnzaiwFXS9tYvBRzyFLlZg_f_Ncs2Za4Q.ttf'
const hankenGroteskSemiBold =
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get parameters
    const title =
      searchParams.get('title') || 'Austrian Occupation Exposure Map'

    // Load static font weights from Google Fonts CDN
    const [fontRegular, fontSemiBold] = await Promise.all([
      fetch(hankenGroteskRegular).then((res) => res.arrayBuffer()),
      fetch(hankenGroteskSemiBold).then((res) => res.arrayBuffer()),
    ])
    ...
    return new ImageResponse(
      (
        ...
        >
          {/* Logo - webconsulting.at SVG */}
          <svg
            width="356"
            height="48"
            viewBox="0 0 237.06 32"
            style={{ flexShrink: 0 }}
          >
            {/* Text: webconsulting */}
            <g>
            ...
            <g>
              ...
              <g>
                ...
                <path fill="#1b7a95" d="M33.52,21.18c.11-.02.21-.06.28-.13l-.28.13Z"/>
              </g>
          ...
          <div
            style={{
              width: '100%',
              height: '6px',
              background: 'linear-gradient(90deg, #1B7A95 0%, #14616B 100%)',
              borderRadius: '3px',
            }}
          />
        </div>
