 ...
 *
 * Generated: 2026-03-29T11:40:40.883Z
...
export const dataTests: DataTest[] = [
  ...
  },
  {
    ...
    description: "Outlook is a normalised WIFO/AMS employment growth signal (−10 to +10). It must remain inside the documented scale.",
    descriptionDe: "Der Ausblick ist ein normalisiertes WIFO/AMS-Beschäftigungswachstumssignal (−10 bis +10). Er muss in der dokumentierten Skala bleiben.",
    test: () => {
  ...
  },
  {
    ...
    description: "Jobs-weighted mean outlook should sit near zero (±3). Strong drift would hint at systematic bias in the WIFO/AMS mapping.",
    descriptionDe: "Beschäftigungsgewichteter Mittelwert des Ausblicks soll nahe 0 liegen (±3). Starke Drift würde auf systematische Verzerrung in der WIFO/AMS-Zuordnung hindeuten.",
    test: () => {
