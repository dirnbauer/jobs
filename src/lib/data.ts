 ...
 *
 * Generated: 2026-03-28T21:03:49.779Z
 ...
 * (100.0% — should be ~100% after rounding; 71 occupation groups)
 */
...
export const austrianOccupations: Occupation[] = [
  ...
  },
  {
    ...
    source: "Eurostat lfsa_egai2d (2024) ISCO-08 26: 144,600 employed (LFS/Mikrozensus AKE) × 49.7% NACE weight (nama_10_a64_e: NACE J58) | Pay: VSE 2022 ISCO-08 26 (€22.88/h median × 2080h × 1.17) | Pipeline: scripts/generate-occupations.ts → deterministic build, all source data publicly downloadable (OGD), 30+ automated integrity tests",
  },
  {
    ...
    source: "Eurostat lfsa_egai2d (2024) ISCO-08 26: 144,600 employed (LFS/Mikrozensus AKE) × 50.3% NACE weight (nama_10_a64_e: NACE J59_J60) | Pay: VSE 2022 ISCO-08 26 (€22.88/h median × 2080h × 1.17) | Pipeline: scripts/generate-occupations.ts → deterministic build, all source data publicly downloadable (OGD), 30+ automated integrity tests",
  },
  {
  ...
  },
  {
    ...
    source: "Eurostat lfsa_egai2d (2024) ISCO-08 43: 130,500 employed (LFS/Mikrozensus AKE) × 100.0% NACE weight (nama_10_a64_e: NACE N) | Pay: VSE 2022 ISCO-08 43 (€17.84/h median × 2080h × 1.17) | Pipeline: scripts/generate-occupations.ts → deterministic build, all source data publicly downloadable (OGD), 30+ automated integrity tests",
  },
  {
  ...
  },
  {
    ...
    source: "Eurostat lfsa_egai2d (2024) ISCO-08 41: 197,200 employed (LFS/Mikrozensus AKE) × 100.0% NACE weight (nama_10_a64_e: NACE N) | Pay: VSE 2022 ISCO-08 41 (€16.91/h median × 2080h × 1.17) | Pipeline: scripts/generate-occupations.ts → deterministic build, all source data publicly downloadable (OGD), 30+ automated integrity tests",
  },
  {
    ...
    source: "Eurostat lfsa_egai2d (2024) ISCO-08 91: 147,600 employed (LFS/Mikrozensus AKE) × 100.0% NACE weight (nama_10_a64_e: NACE N) | Pay: VSE 2022 ISCO-08 91 (€10.8/h median × 2080h × 1.17) | Pipeline: scripts/generate-occupations.ts → deterministic build, all source data publicly downloadable (OGD), 30+ automated integrity tests",
  },
  {
