...
export const howItWorksCopy = {
  ...
  en: {
    ...
    dataBody:
      "Employed persons: Eurostat lfsa_egai2d (EU Labour Force Survey 2024; for Austria: Mikrozensus-Arbeitskräfteerhebung). NACE sector employment (nama_10_a64_e) serves exclusively as proportional weighting per occupation row. Earnings: Structure of Earnings Survey 2022 (Statistik Austria, Open Government Data) by ISCO-08. Outlook: WIFO/AMS Medium-Term Employment Forecast 2023–2030 (Tabellenband, Dec. 2024). AI impact fields: scripts/generate-occupations.ts → OCCUPATION_DEFS; the build process calls no LLM API. On every regeneration, 99 hypothesis-driven tests verify employment totals, earnings plausibility, ISCO consistency, and AI impact distribution. Every figure is traceable to a public source with a download link.",
